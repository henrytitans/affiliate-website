      ...
      <Link href={`/casinos/${casino.slug.current}`} className="block">
        <div className="relative p-6">
          <div className="flex items-start gap-4 mb-4">
            {/* Rank badge */}
            {rank && (
              <div className="absolute -top-1 -left-1 w-8 h-8 bg-gradient-gold text-background text-sm font-bold rounded-br-xl flex items-center justify-center">
                #{rank}
              </div>
            )}
